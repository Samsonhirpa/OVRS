<div class="content-wrapper">
 ...
 <form role="form" action="<?php echo base_url('ESport/save_waldaalee'); ?>" method="Post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                             foreach ($this->ek->getwaldale($this->session->userdata('full_name')) as $row) {
                                    $no++;
                                    ?>
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                                          ...
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('ESport/Delete_Waldaalee/' . $row->wl_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->wl_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('ESport/Edit_wirtu/' . $row->wl_id) ?>"method="post">

...
?>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <h3 class="box-title" align="center">Baga Nagaan  Gara <?php echo $useraccount->cname;?> Dhuftan</h3>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                <!-- /.post -->
                  ...
                  <div class="row">
<?php
            $zone = $this->session->userdata('city');

if ($zone) {
    // Fetch the count of rows where zone_id matches.
    $this->db->where('magala_id', $zone);
...
?>
        ...
        <a href="<?php echo base_url('MSport/manageclub') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
          </div>
        </div>
        <!-- /.col -->
...
?> 
          ...
          <div class="small-box bg-green" href="<?php echo base_url('ZoneSport/Marshal_arti') ?>">
            ...
            <a href="<?php echo base_url('MSport/Marshal_arti') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
          </div>
        </div>
        <!-- ./col -->
<?php
            $zoni = $this->session->userdata('city');

if ($zoni) {
    // Fetch the count of rows where zone_id matches.
    $this->db->where('magala_id', $zoni);
...
?>
        <div class="col-lg-3 col-xs-6">
         ...
         <a href="<?php echo base_url('MSport/Waldaalee') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
 <?php
...
?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url('MSport/istediyemi') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
       </div>
       </div>
      <?php
            $zoni = $this->session->userdata('city');
...
?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url('MSport/Leenjisummaa') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
       </div>
       </div>
...
?>
       <div class="col-lg-3 col-xs-6">
         ...
         <a href="<?php echo base_url('MSport/Oolmaisporti') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
...
?>
          ...
          <div class="small-box bg-green" href="<?php echo base_url('Sport/Giddugalaleenjii') ?>">
            ...
            <a href="<?php echo base_url('MSport/Giddugalaleenjii') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
          </div>
        </div>
        <!-- ./col -->
...
?>
        ...
        <a href="<?php echo base_url('MSport/Guddattoota') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
          </div>
        </div>
                ...
                <div class="post">
                  ...
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?php echo base_url();?>/dist/img/youthlogo.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Biiroo Dargaggoofi Ispoortii <?php echo $useraccount->cname;?></a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                    <span class="description">Gabaasa waligalaa <?php echo $useraccount->cname;?></span>
                  </div>
                  <!-- /.user-block -->
                     <div class="card-body">
<div class="row">

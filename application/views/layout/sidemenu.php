...
<head>
    <style>
       ...
       :root {
           --sidebar-bg: #0096FF;  /* Background color changed to #0096FF */
           --sidebar-light: #0096FF;
           --sidebar-hover: #0077cc;  /* Slightly darker for hover contrast */
           --accent: #ffffff;
           --accent-dark: #e0e0e0;
           --accent-light: #ffffff;
           --primary: #ffffff;
           --primary-dark: #e0e0e0;
           --text-light: #ffffff;  /* Changed to pure white for better visibility */
           --text-muted: #e0e6f0;  /* Lightened for better contrast on #0096FF */
       ...
       /* Fix for text visibility on hover states */
...
<body>
   ...
   <!-- Baayyina Filattoota (Voter Turnout) for Admin -->
            ...
            <?php elseif ($this->session->userdata('role') == 3): ?>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="header">NAVIGATION</li>
                    <li><a href="<?php echo base_url() ?>VoterTurnout/dashboard"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>

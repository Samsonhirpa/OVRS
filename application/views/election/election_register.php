        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
            <div>
                ...
                <p style="margin: 5px 0 0; color: #6c86a3; font-size: 13px;">
                    <i class="fa fa-flag-checkered"></i> Galmee Filannoo Paartii
                </p>
            </div>
            <div>
                <a href="<?php echo base_url(); ?>ElectionReport/dashboard" class="btn btn-default" style="border-radius: 30px; padding: 8px 25px; border: none; background: #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <form method="post" action="<?php echo base_url('ElectionReport/save'); ?>" id="electionForm">
                        <div style="padding: 30px;">
                            ...
                            <div style="margin-bottom: 35px;">
                                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 25px;">
                                    ...
                                    <h4 style="margin: 0; font-size: 18px; font-weight: 600; color: #1a3c2c;">
                                        <i class="fa fa-info-circle" style="color: #2c5f2d;"></i> Odeeffannoo Filannoo
                                    </h4>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label style="font-weight: 600; color: #2c3e50; margin-bottom: 10px; font-size: 13px;">
                                                <i class="fa fa-user-circle"></i> Gabaasaa
                                            </label>
                                            <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px 16px;">
                                                <i class="fa fa-user"></i> <?php echo $reporter_name; ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div style="margin-bottom: 35px;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="font-weight: 600; color: #2c3e50; margin-bottom: 10px; font-size: 13px;">
                                                Maqaa Paartii <span class="text-red">*</span>
                                            </label>
                                            <select name="party_name" id="party_name" class="form-control" style="height: 48px; border-radius: 12px; border: 2px solid #e2e8f0; padding: 0 15px; font-size: 14px;" required>
                            ...
                            <div style="margin-bottom: 30px;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea name="remarks" class="form-control" rows="3" style="border-radius: 16px; border: 1px solid #e2e8f0; padding: 15px; resize: none; font-size: 14px;" placeholder="Hubannoo yoo jiraate as irratti barreessi (e.g., rakkoolee, hubachiisa, yaaddoo)..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-12 text-center">
                                    ...
                                    <a href="<?php echo base_url(); ?>ElectionReport/dashboard" class="btn btn-outline-info" style="padding: 14px 35px; margin-left: 15px; font-weight: 600; border-radius: 50px; font-size: 16px; background: white; border: 2px solid #cbd5e0; color: #4a5568;">

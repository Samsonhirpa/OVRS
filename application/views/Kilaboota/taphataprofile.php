            ...
            <table class="table table-bordered">
             ...
             <tbody>
               <tr role="row">
                ...
                <td><?php echo $taphata->zname;?></td>
                <td><?php echo $taphata->woreda_name;?></td>
                <td><?php echo $taphata->kname;?></td>
              </tr>
            ...
            <table class="table table-bordered">
             ...
             <tbody>
               <tr role="row">
                ...
                <td><?php echo $taphata->clubtype;?></td>
                <td><?php echo $taphata->sport_type;?></td>

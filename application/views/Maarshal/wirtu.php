            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('Sport/save_wirtu') ?>"method="post">
...
<div class="box box-default">
 ...
 <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">Ogeessa</th>
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->k->getwirtu() as $row) {
                                    $no++;
                                    ?>
                                    <tr role="row" class="odd">
                                         ...
                                         <td><?php echo $row->operator; ?></td> 
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('Sport/Delete_wirtu/' . $row->w_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash">Balleessi</i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->w_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('Sport/Edit_wirtu/' . $row->w_id) ?>"method="post">
                                                             <div class="form-group">
                        <label>Maqaa W/Leenjii</label>

...
<form role="form" action="<?php echo base_url('Structure/saverent'); ?>" method="Post" enctype="multipart/form-data">
...
<div class="row">
                      <div class="col-sm-5">
                         <div class="form-group">
                        <label>VAT/TOT</label>
                         <input type="number" name="vatot" id="math_Results"  class="form-control">
...
<input type="checkbox" name="math_Operators" value="None"  onclick="solve();" />   <label style="color:red;">None</label>
   ...
   <div class="row">
                     ...
                     <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>COST2</label>
                        <input type="text" name="cost2" id="cost2" placeholder="--  COST2  --" class="form-control">
                      </div>
                    </div>

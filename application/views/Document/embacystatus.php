...
<td>
 <a class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-default<?php echo $row->em_id; ?>">Status</a>
  ...
  <div class="form-group">
                                    <label>CUSTOMER NAME</label><br>
                                   <input class="form-control input-lg" value="<?php echo $row->fullname; ?>" type="text" name="woreda_description" placeholder="Description">
                                  </div>
                            </div>
                             <div class="col col-md-12">
  <div class="form-group">
                                    <label>Status</label><br>
                                   <input class="form-control input-lg" value="<?php echo $row->embstatus; ?>" type="text" name="woreda_description" placeholder="Description">

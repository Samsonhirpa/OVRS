...
<div class="box-body">
                  ...
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->str->getcustomerticketpass() as $row) {
                                    $no++;
                                    ?>
   ...
   <td>
                                     <a href="#"onclick="return confirm('Are you sure does completed permit payment ??')"><i <?php if($row->flightstatus == 0 ) { ?> class="fa fa-check "><span style="background-color:orange;" class="badge badge-success bg-success px-3 rounded-pill">Canceled</span></i> <i <?php } if($row->flightstatus == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->flightstatus == 2 ) { ?> ><?php } ?><span style="background-color:green;" class=" fa fa-thumbs-o-up badge badge-success bg-success px-3 rounded-pill">Seccess</span></i> </a>

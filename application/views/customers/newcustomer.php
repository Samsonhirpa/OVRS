...
<form role="form" action="<?php echo base_url('Structure/save_customer'); ?>" method="Post" enctype="multipart/form-data">
                 ...
                 <div class="col col-md-6">
                      ...
                      <div class="form-group">
                        <label>Expire date of Crime Free card</label>
                          <input type="date" name="xdateofcrime" id="expire" onchange=""  class="form-control"  >
                      </div>
...
function notifydate22(){
  var exp = parseFloat(document.getElementById("expire").value);
var today = new Date();
var priorDate = new Date(new Date().setDate(today.getDate() - 30));

console.log(today)
console.log(priorDate);
var thirtyDays = new Date(new Date().setDate(exp.getDate() - 30));

  
  document.getElementById("notify").value =  thirtyDays;

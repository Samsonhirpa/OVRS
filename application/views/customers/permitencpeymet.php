...
<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 90.95px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">File</th>
 <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 95.733px;" aria-label="Browser: activate to sort column ascending">PAYMENT</th>
...
<form role="form" action="<?php echo base_url('Structure/updatepermitencpayment/' . $row->id); ?>" method="Post" enctype="multipart/form-data">
...
<!-- 	 <div class="form-group">
                               ...
                               <input type="text" name="remaining" id="remaining" value="<?php echo $ntacustomers->remaining;?>" class="form-control"  onchange="paymentstatus() " readonly>
                                ...
                                <input class="form-control" type="text" name="permitpay" id="permitpay" onchange="calcremaining()" value="<?php echo $row->permitpay; ?>" required>
                                       </div>

                                <div class="form-group">
                                <label>Bank Name</label><br>
                                <input class="form-control" type="text" name="bankname1" value="<?php echo $row->bankname1; ?>" required>
                                       </div>
                                 <div class="form-group">

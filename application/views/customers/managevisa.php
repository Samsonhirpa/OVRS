...
<div class="container-fluid">
      <h3 class="box-title"><i class="fa fa-plus-square">LIST OF CUSTOMERS WHO ARE WAITING FOR VISA TO CAME</i></h3>
...
<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 90.95px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Expire Date [CrimeFree]</th>
                     ...
                     <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 90.733px;" aria-label="Browser: activate to sort column ascending">Remaining</th>
                         <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 90.733px;" aria-label="Browser: activate to sort column ascending">Permit Approved by</th>
                         <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 120.733px;" aria-label="Browser: activate to sort column ascending">VISA</th>
                 ...
                 <tbody>
                  ...
                  $no = 0;
                        ...
                        foreach ($this->str->getntcustomervisa() as $row ) {
                        $no++;
                        ?>
                    ...
                    <td>
                       <a class="btn btn-xs btn-success" href="<?php echo base_url('Structure/show_customer/'.$row->id)?>"><i class="fa fa-windows"></i></a>
                                     <a class="btn btn-xs alert-success" href="<?php echo base_url('structure/visa_status/'.$row->id)?>"onclick="return confirm('Are you sure does customer visa arrived ??')"><i <?php if($row->visastatus == 0 ) { ?> class="fa fa-cloud-upload ">WAITING </i> <i <?php } if($row->visastatus == 1 ) { ?> class="fa fa-cloud-upload"> Reject </i> <i <?php } if($row->visastatus == 2 ) { ?> class="fa fa-thumbs-o-up"><?php } ?>RECEIVED</i> </a>

                  ...
                  $no = 0;
                    ...
                    <td>
                       ...
                       <a class="btn btn-xs btn-success" href="<?php echo base_url('Structure/show_customer/'.$row->id)?>"><i class="fa fa-windows"></i></a>
                        <a class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal-default<?php echo $row->id; ?>" ><i class="fa fa-edit">Add FP</i></a>
...
<form role="form" action="<?php echo base_url('Structure/updateencpayment/' . $row->id); ?>" method="Post" enctype="multipart/form-data">

  <div class="form-group">
                                <label>Remaining</label><br>
                                <input class="form-control"  type="text" name="remaining"  value="<?php echo $row->remaining; ?>" readonly>
                                       </div>
                                 <div class="form-group">

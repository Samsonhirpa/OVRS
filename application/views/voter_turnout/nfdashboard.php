nfdashboard.php<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Naannoo Filannoo Dashboard | Baayyina Filattoota</title>
    <!-- Font Awesome 4.7 -->
    ...
    <style>
        ...
        * {
        ...
        /* TOP MENU - DARK BLUE BRAND COLOR (UNCHANGED) */
        .main-header {
        ...
        .col-md-3, .col-md-4, .col-md-6, .col-md-12, .col-xs-6, .col-sm-6 {
            padding: 0 10px;
            box-sizing: border-box;
        }
        .col-md-3 { width: 25%; }
        ...
        @media (max-width: 768px) {
            .col-md-3, .col-md-4, .col-md-6 { width: 100%; margin-bottom: 15px; }
...
<!-- TOP MENU - DARK BLUE (UNCHANGED) -->
<div class="main-header">
    <div class="logo-area">
        <div class="logo-icon"><i class="fa fa-bar-chart"></i></div>
        <div class="logo-text">Filannoo Election Hub</div>
    </div>
    <div class="nav-links">
        <a href="#"><i class="fa fa-dashboard"></i> Dashboard</a>
        <a href="<?php echo base_url('VoterTurnout/register'); ?>"><i class="fa fa-plus-circle"></i> Galmeessi</a>
        <a href="<?php echo base_url('VoterTurnout/listReports'); ?>"><i class="fa fa-list"></i> Gabaasawwan Koo</a>
        <div class="user-badge">
            <i class="fa fa-user-circle"></i>
            <span><?php echo $this->session->userdata('full_name') ?: 'Naannoo Filannoo'; ?></span>
        </div>
    </div>
</div>
...
<div class="content-wrapper">
    ...
    <div class="dashboard-header animate-slide">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
            <h1>
                ...
                Daashboordii Naannoo Filannoo
                <small style="font-size: 13px; color: #6c757d; margin-left: 8px; font-weight: normal;">Voter Turnout Report</small>
            </h1>
            <div class="region-badge">
                <i class="fa fa-flag-checkered"></i>
                Naannoo: <strong><?php echo $voting_region_name; ?></strong>
            </div>
        </div>
        <div style="margin-top: 12px;">
            <a href="<?php echo base_url(); ?>dashboard" style="color: #6c757d; font-size: 12px;"><i class="fa fa-home"></i> Manii</a>
            <span style="margin: 0 5px; color: #999;">›</span>
            <span style="color: #999;">Daashboordii Naannoo Filannoo</span>
        </div>
    </div>
    ...
    <section class="content" style="padding: 0;">
        ...
        <div class="filter-form animate-slide" style="animation-delay: 0.05s;">
            <form method="get" action="<?php echo base_url('VoterTurnout/regionDashboard'); ?>">
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-md-12 text-right">
                        ...
                        <a href="<?php echo base_url('VoterTurnout/regionDashboard'); ?>" class="btn-modern btn-teal"><i class="fa fa-refresh"></i> Haari</a>
                    </div>
                </div>
            </form>
        </div>

        <!-- KPI Summary Cards (NO Yeroo Calleessaa Card) -->
        <div class="row animate-slide" style="animation-delay: 0.1s;">
            <div class="col-xs-6 col-sm-6 col-md-4">
                <div class="stat-card primary">
                    <div class="stat-icon"><i class="fa fa-file-text-o"></i></div>
                    <div class="stat-value"><?php echo number_format($stats['total_reports'] ?? 0); ?></div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-4">
                <div class="stat-card teal">
                    ...
                    <div class="stat-value"><?php echo number_format($stats['total_voters'] ?? 0); ?></div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-4">
                <div class="stat-card gold">
                    ...
                    <div class="stat-value"><?php echo number_format($stats['avg_voters_per_report'] ?? 0); ?></div>
                    <p class="stat-label">Giddugaleessa Filattoota / Gabaasa</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="chart-container">
                                    <canvas id="securityStatusChart" style="height: 260px; width: 100%;"></canvas>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="modern-card">
                    ...
                    <div class="card-body">
                        <?php 
                            ...
                            $maleVoters = $stats['male_voters'] ?? 0;
                            $femaleVoters = $stats['female_voters'] ?? 0;
                            $malePercent = $totalVoters > 0 ? round(($maleVoters / $totalVoters) * 100, 1) : 0;
                            $femalePercent = $totalVoters > 0 ? round(($femaleVoters / $totalVoters) * 100, 1) : 0;
                        ?>
                        <div style="height: 40px; border-radius: 30px; overflow: hidden; margin: 10px 0; display: flex;">
                            <div style="background: #2c5f2d; width: <?php echo $malePercent; ?>%; display: flex; align-items: center; justify-content: center; color: white; font-size: 14px; font-weight: 600;">
                                Dhiirii <?php echo number_format($maleVoters); ?> (<?php echo $malePercent; ?>%)
                            </div>
                            <div style="background: #e6a017; width: <?php echo $femalePercent; ?>%; display: flex; align-items: center; justify-content: center; color: #333; font-size: 14px; font-weight: 600;">
                                Dubartii <?php echo number_format($femaleVoters); ?> (<?php echo $femalePercent; ?>%)
                            </div>
                        </div>
                        <div class="row" style="margin-top: 20px;">
                            <div class="col-xs-6 text-center">
                                <div style="background: #e8f5e9; padding: 15px; border-radius: 12px;">
                                    ...
                                    <h3 style="margin: 10px 0 5px; font-weight: 700;"><?php echo number_format($maleVoters); ?></h3>
                            ...
                            <div class="col-xs-6 text-center">
                                <div style="background: #fff3e0; padding: 15px; border-radius: 12px;">
                                    ...
                                    <h3 style="margin: 10px 0 5px; font-weight: 700;"><?php echo number_format($femaleVoters); ?></h3>
        ...
        <!-- Recent Reports Table (Only this region's data) -->
        <div class="modern-card animate-slide" style="animation-delay: 0.3s;">
            <div class="card-header">
                <h3><i class="fa fa-list"></i> Gabaasawwan Dhiyaa (Recent Reports - <?php echo $voting_region_name; ?>)</h3>
                <div>
                    ...
                    <table class="table-modern">
                        ...
                        <tbody>
                            <?php if(!empty($recent_reports)): ?>
                                <?php $counter = 1; foreach($recent_reports as $report): ?>
                                    <?php
                                        $statusClass = '';
                                        $statusIcon = '';
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo date('d/m/Y', strtotime($report->report_date)); ?></strong></td>
                                        <td><?php echo $report->report_session; ?> (<?php echo date('H:i', strtotime($report->created_at)); ?>)</td>
                                        ...
                                        <td class="text-center"><strong><?php echo number_format($report->total_voters); ?></strong></td>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url('VoterTurnout/viewReport/'.$report->id); ?>" class="btn-modern" style="background:#17a2b8; color:white; padding:4px 10px; font-size:11px;">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center" style="padding: 40px;">
                                        ...
                                        <p style="margin-top: 10px;">Gabaasi hin jiru!</p>
        ...
        <!-- Action Buttons -->
        <div class="row animate-slide" style="animation-delay: 0.35s;">
            <div class="col-xs-12 text-right" style="margin-top: 10px; margin-bottom: 30px;">
                ...
                <a href="<?php echo base_url('VoterTurnout/listReports'); ?>" class="btn-modern btn-teal" style="margin-left: 10px;">
                    <i class="fa fa-list"></i> Gabaasawwan Koo Hunda Ilaali
                </a>
            </div>
        </div>

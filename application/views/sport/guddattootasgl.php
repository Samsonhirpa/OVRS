...
<form role="form" action="<?php echo base_url('Sport/save_gudslg'); ?>" method="Post" enctype="multipart/form-data">
                        ...
                        <tbody>
                              ...
                              <td>
                                    <img src="<?= base_url('upload/'.$row->file_name) ?>" height="40px" width="40px">
                                          ...
                                          <td>
                                                <a class="btn btn-xs btn-success" href="<?php echo base_url('Sport/profileGuddattootaSLG/'.$row->gslg_id)?>"><i class="fa fa-windows"></i></a>
                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url('Sport/Delete_guddattootasgl/' . $row->gslg_id ) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>

...
<div class="box box-default">
          <div class="box-headerS with-border">
           <h3 class="box-title"><a href="<?php echo base_url('MSport/addGaree') ?>" class="btn btn-primary"><i class="fa fa-plus-square">Dabalii Galmeessi </i></a></h3>
          </div>
          <div class="box-body">
            ...
            <thead  class="thead-success">
                 ...
                 <tbody>
                  ...
                  $no = 0;
                        ...
                        foreach ($this->mk->getgaree() as $row) {
                        $no++;
                        ?>
                        <tr role="row" class="odd">
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                             ...
                             <td>
                    <a class="btn btn-sm btn-info"href="<?php echo base_url('MSport/Updategaree/'.$row->gr_id)?>"><i class="fa fa-wrench"></i></a>
                 <!-- <a class="btn btn-sm btn-success" href="<?php echo base_url('MSport/saveclub/'.$row->k_id)?>"><i class="fa fa-windows"></i></a> -->
                    <a class="btn btn-sm btn-danger" href="<?php echo base_url('MSport/Delete_garee/'.$row->gr_id)?>"onclick="return confirm('Are you sure To Delete This Information ??')"><i class="fa fa-trash"></i></a>

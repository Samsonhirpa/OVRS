        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?php echo form_open_multipart('officer/create', ['id' => 'officerForm']); ?>
                        ...
                        <div class="callout callout-info">
                            <h4 class="box-title">
                                <i class="fa fa-info-circle"></i> Officer Information
                            </h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-2" id="photoPreview" style="display: none;">
                                        <h5 style="color: #4e73df; font-size: 13px; margin-bottom: 10px;">
                                            <i class="fa fa-eye"></i> Photo Preview:
                                        </h5>
                        ...
                        <!-- Submit Button - INDEX STYLE BUTTONS -->
                        <div class="row mt-4">
                            <div class="col-md-12">

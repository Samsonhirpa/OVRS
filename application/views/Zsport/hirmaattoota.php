            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('ZoneSport/save_Hirmaattoota') ?>"method="post">
                     ...
                     -->
                       ...
                       <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Ida.</th>
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->zk->getHirmaattoota() as $row) {
                                    $no++;
                                    ?>
                                    ...
                                    <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td> 
                                          ...
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('ZoneSport/Delete_Hirmaattoota/' . $row->hir_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->hir_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
            <form action="<?php echo base_url('ZoneSport/Edit_Hirmaattoota/' . $row->hir_id) ?>"method="post">

            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('ZoneSport/save_olmaisporti') ?>"method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->zk->getolmaisporti() as $row) {
                                    $no++;
                                    ?>
                                    <tr role="row" class="odd">
                                          ...
                                          <td>
                                            <a href="<?php echo base_url().'ZoneSport/downloadkarta/'.$row->ol_id; ?>" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-download-alt"></a>
                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url('ZoneSport/Delete_olmaisporti/' . $row->ol_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->ol_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('Sport/Edit_olmaisporti/' . $row->ol_id) ?>"method="post">

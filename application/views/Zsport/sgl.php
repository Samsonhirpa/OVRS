            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('ZoneSport/save_sgl') ?>"method="post">
                        ...
                        <tbody>
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                                         ...
                                         <td><?php echo $row->operator; ?></td>
                                          ...
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('ZoneSport/Delete_sgl/' . $row->sgl_id) ?>"onclick="return confirm('Are you sure To Delete ?')">Delete<i class="fa fa-trash"></i></a>

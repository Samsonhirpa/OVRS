            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('ZoneSport/save_Guddattoota') ?>"method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->zk->getGuddattoota() as $row) {
                                    $no++;
                                    ?>
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                                          ...
                                          <td>
                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url('ZoneSport/Delete_Guddattoota/' . $row->gu_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->gu_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('ZoneSport/Edit_Guddattoota/' . $row->gu_id) ?>"method="post">
                                                             <div class="form-group">
                        <label>Maqaa Guutuu </label>

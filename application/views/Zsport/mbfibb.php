...
<div class="box box-default">
 ...
 <?php
                              $no = 0;
                              foreach ($this->zk->getmbfibb() as $row) {
                                    $no++;
                                    ?>
                                    <tr role="row" class="odd">
                                         ...
                                         <td><?php echo $row->zname . ' ' . $row->cname  ; ?></td><td><?php echo $row->kg; ?></td>
                                          ...
                                          <td>
                                                  <a class="btn btn-sm btn-danger" href="<?php echo base_url('ZoneSport/Delete_mbfibb/' . $row->mb_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>

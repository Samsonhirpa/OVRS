            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <h4 class="modal-title">Guca Leenjii Leenjisummaa  Ispoortii </h4>
                        </div>
                        <div class="modal-body">
                              <form action="<?php echo base_url('ESport/save_Leenjisummaa') ?>"method="post">
...
<select id="multipleSelect" name="slenji" data-search="true" data-silent-initial-value-set="true" required>
                      <option value="">-- Sadarkaa Fili  --</option>
                        ...
                        <option value="C-license ">C-license </option>
                        <option value="B-license ">B-license </option>
                        <option value="A-license">A-license </option>
                        <option value="Initernaashinaala">Profeshinaala </option>
                        <option value="sad.1ffaa ">sad.1ffaa </option>
                        <option value="sad.2ffaa ">sad.2ffaa </option>
                        <option value="sad.3ffaa ">sad.3ffaa </option>
                        <option value="Inistraakteera">Inistraakteera</option>
...
<div class="container-fluid">
      <h3 class="box-title"><i class="fa fa-plus-square">Odeeffannoo Guca Leenjii Leenjisummaa Ispoortii</i></h3>


<div class="box box-default">
          <div class="box-header with-border">
            <button type="button"  data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-plus-square btn btn-primary">Leenjii Leenjisummaa Dabali</i>
      </button>
</div>
                  ...
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        <thead style="background-color: #666666; color: white">
                              <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">Ganda</th>
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->ek->getLeenjisummaa($this->session->userdata('full_name')) as $row) {
                                    $no++;
                                    ?>
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                                         ...
                                         <td> <a class="btn btn-xs btn-primary" href="<?php echo base_url('ESport/CertificateLenji/' . $row->lenji_id) ?>"><i class="fa fa-save"></i>PRINT</a></td>
                                         
                                          <td>


                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url('ESport/Delete_lenji/' . $row->lenji_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i>Haqi</a>


                                                <a class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal-default<?php echo $row->lenji_id; ?>" onclick="return confirm('Are you sure To Edit ?')"><i class="fa fa-edit">Foyyessi</i></a>
                                          </td>
                                    </tr>


                              <div class="modal fade" id="modal-default<?php echo $row->lenji_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                <div class="modal-header">
                                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('ESport/Edit_lenji/' . $row->lenji_id) ?>"method="post">
                                                             <div class="form-group">
                        <label>Maqaa Guutuu</label>

<div class="content-wrapper">
            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <h4 class="modal-title">Daabbata Sagantaa Leenjii Guddattootaa /SLG/</h4>
                        </div>
                        <div class="modal-body">
                              <form action="<?php echo base_url('ESport/save_sgl') ?>"method="post">
      ...
      <div class="row">
              <div class="col-sm-6">
                     <div class="form-group">
                        <label>Maqaa SGL</label>
                      <input type="text" name="maqasgl" placeholder="-- Maqaa SGL Galchii --" class="form-control">
                </div>
                    </div>
        <div class="col-sm-6">
            <div class="form-group" >
  ...
  <div class="row">
                    ...
                    <div class="col-sm-6">
                     <div class="form-group">
                        <label>Bara Hundeeffame</label>
                      <input type="date" name="barahun" class="form-control">
                </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Kan Deggeru</label>
                       <select  class="form-control" name="degeraa" required>
                                                             <option value="">-- Select  --</option>
                        <option value="Mana Maree Aanaatiin ">Mana Maree Aanaatiin</option>
                        <option value="Mana Maree Godinatiin ">Mana Maree Godinatiin</option>
                        <option value="Mana Maree Bul/Magaalaatiin ">Mana Maree Bul/Magaalaatiin </option>
                        <option value="Mana Maree Kutaa Magaalatiin ">Mana Maree Kutaa Magaalatiin </option>
                        <option value="Mana Maree Naannootiin ">Mana Maree Naannootiin </option>
                        <option value="Federeeshinii Biyyoolessaatiin ">Federeeshinii Biyyoolessaatiin </option>
                        <option value="Abbootii Qabeenyaa/Nama Dhuunfaatiin ">Abbootii Qabeenyaa/Nama Dhuunfaatiin </option>
           ...
           <?php foreach ($this->k->getSporttype() as $row){
            ...
            <div class="row">
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Maqaa Leenjisaa</label>
                      <input type="text" name="len_name" placeholder="-- Maqaa Leenjisaa --" class="form-control">
                </div>
                    </div>
                    <div class="col-sm-6">
                     <div class="form-group">
                        <label>Bilbila</label>
                      <input type="number" name="bilbila" placeholder="-- Bilbila --" class="form-control">
                </div>
                    </div>
...
<div class="container-fluid">
      <h3 class="box-title"><i class="fa fa-plus-square">Ragaa Sagantaa Leenjii Guddattootaa /SLG/ Oromiyaa Keessatti Argaman</i></h3>


<div class="box box-default">
          <div class="box-header with-border">
            <button type="button"  data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-plus-square btn btn-primary">SLG Dabali</i>
      </button>
</div>
                  ...
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        <thead style="background-color: #666666; color: white">
                              <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">Maqaa SLG</th>

                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-label="Platform(s): activate to sort column ascending">Gosa Ispoortii</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-label="Platform(s): activate to sort column ascending">Bara Hundaa'e</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-label="Platform(s): activate to sort column ascending">Kan Deggeramu</th>
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Maqaa Leenjisaa</th>

                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;" aria-label="Platform(s): activate to sort column ascending">Bilbilaa</th>
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                             foreach ($this->ek->getsgl($this->session->userdata('full_name')) as $row) {
                                    $no++;
                                    ?>
                                    <tr role="row" class="odd">
                                          ...
                                          <td><?php echo $row->barahun; ?></td>
                                          <td><?php echo $row->degeraa; ?></td>
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                                          ...
                                          <td><?php echo $row->len_name; ?></td>
                                          <td><?php echo $row->bilbila; ?></td>
                                         
                                         <td><?php echo $row->operator; ?></td>
                                         
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('ESport/Delete_sgl/' . $row->sgl_id) ?>"onclick="return confirm('Are you sure To Delete ?')">Delete<i class="fa fa-trash"></i></a>

...
<div class="box box-default">
          <div class="box-headerS with-border">
           <h3 class="box-title"><a href="<?php echo base_url('ESport/Leenjisummaa') ?>" class="btn btn-primary"><i class="fa fa-arrow-circle-left">Back To List </i></a> : <a class="btn btn-primary" onclick="myfun('divone')"><i class="fa fa-bars">Print </i></a></h3>
          </div>

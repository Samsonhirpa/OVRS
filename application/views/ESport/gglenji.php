            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('ESport/save_ggl') ?>"method="post">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->ek->getggl($this->session->userdata('full_name')) as $row) {
                                    $no++;
                                    ?>
                                    <tr role="row" class="odd">
                                         ...
                                         <td><?php echo $row->operator; ?></td>
                                          ...
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('ESport/Delete_ggl/' . $row->ggl_id) ?>"onclick="return confirm('Are you sure To Delete ?')">Delete<i class="fa fa-trash"></i></a>

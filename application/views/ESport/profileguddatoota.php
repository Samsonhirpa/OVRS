...
<div class="nav-tabs-custom">
      ...
      <div class="col-lg-4">
        ...
        <img  style="height: 150px; width: 150px;"  src="<?php echo base_url()?>upload/<?php echo $gslg->file_name?>"  alt="not displaying">
         ...
         <p class="mb-0"><strong class="pr-1">Maqaa Haadhaa:</strong><?php echo $gslg->haadha;?> </p>
         <p class="mb-0"><strong class="pr-1">Bilbila Maatii:</strong><?php echo $gslg->bilbilamati;?> </p>
            ...
            <table class="table table-bordered">
             ...
             <tbody>
               <tr role="row">
                ...
                <td><?php echo $gslg->gslg_zname;?><?php echo $gslg->gslg_cname;?></td>
                <td><?php echo $gslg->gslg_wname;?><?php echo $gslg->gslg_scname;?></td>
                <td><?php echo $gslg->gslg_kname;?><?php echo $gslg->gslg_scwname;?></td>
              </tr>
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
             ...
             <tbody>
               <tr role="row">
                <td><strong>Oromiyaa</strong></td>
               <td><?php echo $gslg->slg_zname;?><?php echo $gslg->slg_cname;?></td>
                <td><?php echo $gslg->slg_wname;?><?php echo $gslg->slg_scname;?></td>
                <td><?php echo $gslg->slg_kname;?><?php echo $gslg->slg_scwname;?></td>
              </tr>
...
<!-- 
 ...
 -->
        ...
        <table>
            <p class="mb-0"><strong class="pr-1">Ogeessa Galmeesse:</strong>  &nbsp; &nbsp;<?php echo $gslg->gslg_operator;?></p>

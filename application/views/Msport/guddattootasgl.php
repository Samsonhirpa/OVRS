...
<form role="form" action="<?php echo base_url('MSport/save_gudslg'); ?>" method="Post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->mk->getgslg() as $row) {
                                    $no++;
                                    ?>
                              ...
                              <td>
                                    <img src="<?= base_url('upload/'.$row->file_name) ?>" height="40px" width="40px">
                                          ...
                                          <td>
                                                <a class="btn btn-xs btn-success" href="<?php echo base_url('MSport/profileGuddattootaSLG/'.$row->gslg_id)?>"><i class="fa fa-windows"></i></a>
                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url('MSport/Delete_guddattootasgl/' . $row->gslg_id ) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>

            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('MSport/save_Giddugalaleenjii') ?>"method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->mk->getGiddugalaleenjii() as $row) {
                                    $no++;
                                    ?>
                                    ...
                                    <img src="<?= base_url('upload/'.$row->attachment) ?>" height="40px" width="40px">
                                          ...
                                          <td>
                                                <a class="btn btn-sm btn-danger" href="<?php echo base_url('MSport/Delete_Giddugalaleenjii/' . $row->gl_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->gl_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('MSport/Edit_Giddugalaleenjii/' . $row->gl_id) ?>"method="post">

            ...
            <div class="modal-dialog">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form action="<?php echo base_url('MSport/save_murteessummaa') ?>"method="post">
            ...
            <div class="box-body">
                  <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                              <?php
                              $no = 0;
                              foreach ($this->mk->getMurteessummaa() as $row) {
                                    $no++;
                                    ?>
                            ...
                            <td><?php echo $row->kname. ' ' . $row->sbw_name; ?></td>
                                       ...
                                       <td> <a class="btn btn-xs btn-primary" href="<?php echo base_url('MSport/CertificateMurte/' . $row->mur_id) ?>"><i class="fa fa-save"></i>PRINT</a></td>
                                         
                                         
                                          <td>
                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url('MSport/Delete_lenjim/' . $row->mur_id) ?>"onclick="return confirm('Are you sure To Delete ?')"><i class="fa fa-trash"></i></a>
                              ...
                              <div class="modal fade" id="modal-default<?php echo $row->mur_id; ?>">
                                    <div class="modal-dialog">
                                          <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                 <form action="<?php echo base_url('MSport/Edit_lenji/' . $row->mur_id) ?>"method="post">
                                                             <div class="form-group">
                        <label>Maqaa Guutuu</label>

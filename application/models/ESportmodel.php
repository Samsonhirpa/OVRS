...
class ESportmodel extends CI_Model
{
...
public function getGuddattoota($user){
            $this->db->select('*');
...
// public function getgslg($user){
//             $this->db->select('*');
//     $this->db->from('gslg');
//        $this->db->where('gslg.operator',$user);
...
public function getgslg($user) {
    $this->db->select('gslg.*, gslg.operator AS gslg_operator ,sgl.maqasgl'); // Alias gslg.operator
    $this->db->from('gslg');
    $this->db->where('gslg.operator', $user);
    $this->db->order_by('gslg_id', 'DESC');
    $this->db->join('sgl', 'sgl.sgl_id = gslg.bslg_id', 'left');
...
public function getLeenjisummaa($user){
            $this->db->select('*');
    $this->db->from('lenji');
       $this->db->where('operator',$user);
...
public function getMurteessummaa($user){
            $this->db->select('*');
    $this->db->from('murte');
       $this->db->where('operator',$user);
...
public function gettaphata($user){
            $this->db->select('*');
    ...
    $this->db->join('woreda AS woreda_gslg', 'woreda_gslg.woreda_id = taphata.woreda_id', 'left');
    $this->db->join('zone AS zone_gslg', 'zone_gslg.zid = taphata.zone_id', 'left');
    $this->db->join('kebele AS kebele_gslg', 'kebele_gslg.kid = taphata.ganda_id', 'left');
     $this->db->join('city AS city_gslg', 'city_gslg.cid = taphata.magala_id', 'left');
    $this->db->join('subcity AS subcity_gslg', 'subcity_gslg.subcity_id = taphata.kmagala_id', 'left');
    $this->db->join('subcity_woreda AS swcity_gslg', 'swcity_gslg.sbw_id = taphata.akmagala_id', 'left');

     $this->db->join('woreda AS woreda_slg', 'woreda_slg.woreda_id = kilabi.woreda_id', 'left');
    $this->db->join('zone AS zone_slg', 'zone_slg.zid = kilabi.zone_id', 'left');
    $this->db->join('kebele AS kebele_slg', 'kebele_slg.kid = kilabi.ganda_id', 'left');
     $this->db->join('city AS city_slg', 'city_slg.cid = kilabi.magala_id', 'left');
    $this->db->join('subcity AS subcity_slg', 'subcity_slg.subcity_id = kilabi.kmagala_id', 'left');
    $this->db->join('subcity_woreda AS swcity_slg', 'swcity_slg.sbw_id = kilabi.akmagala_id', 'left');
 ...
 $this->db->select('taphata.*, 
    taphata.operator AS taphata_operator ,
    zone_taph.zname AS taph_zname ,
    woreda_taph.woreda_name AS taph_wname ,
    kebele_taph.kname AS taph_kname ,
    city_taph.cname AS taph_cname ,
    subcity_taph.subcity_name AS taph_scname ,
    swcity_taph.sbw_name AS taph_scwname ,

     zone_kil.zname AS kil_zname ,
    woreda_kil.woreda_name AS kil_wname ,
    kebele_kil.kname AS kil_kname ,
    city_kil.cname AS kil_cname ,
    subcity_kil.subcity_name AS kil_scname ,
    swcity_kil.sbw_name AS kil_scwname ,
    clubtype_kil.ct_name AS clubtype_name ,
    sporttype_kil.spt_name AS sporttype_name ,
    ...
    $this->db->join('kilabi', 'kilabi.k_id = taphata.kilabi_id', 'left');
    $this->db->join('woreda AS woreda_taph', 'woreda_taph.woreda_id = taphata.woreda_id', 'left');
    $this->db->join('zone AS zone_taph', 'zone_taph.zid = taphata.zone_id', 'left');
    $this->db->join('kebele AS kebele_taph', 'kebele_taph.kid = taphata.ganda_id', 'left');
     $this->db->join('city AS city_taph', 'city_taph.cid = taphata.magala_id', 'left');
    $this->db->join('subcity AS subcity_taph', 'subcity_taph.subcity_id = taphata.kmagala_id', 'left');
    $this->db->join('subcity_woreda AS swcity_taph', 'swcity_taph.sbw_id = taphata.akmagala_id', 'left');

     $this->db->join('woreda AS woreda_kil', 'woreda_kil.woreda_id = kilabi.woreda_id', 'left');
    $this->db->join('zone AS zone_kil', 'zone_kil.zid = kilabi.zone_id', 'left');
    $this->db->join('kebele AS kebele_kil', 'kebele_kil.kid = kilabi.ganda_id', 'left');
     $this->db->join('city AS city_kil', 'city_kil.cid = kilabi.magala_id', 'left');
    $this->db->join('subcity AS subcity_kil', 'subcity_kil.subcity_id = kilabi.kmagala_id', 'left');
    $this->db->join('subcity_woreda AS swcity_kil', 'swcity_kil.sbw_id = kilabi.akmagala_id', 'left'); 
   $this->db->join('clubtype AS clubtype_kil ', 'clubtype_kil.ct_id = kilabi.clubtype', 'left');
    $this->db->join('sporttype AS sporttype_kil', 'sporttype_kil.spt_id = kilabi.sport_type', 'left');
    ...
    $this->db->select('gslg.*, 
    gslg.operator AS gslg_operator ,
    zone_gslg.zname AS gslg_zname ,
    woreda_gslg.woreda_name AS gslg_wname ,
    kebele_gslg.kname AS gslg_kname ,
    city_gslg.cname AS gslg_cname ,
    subcity_gslg.subcity_name AS gslg_scname ,
    swcity_gslg.sbw_name AS gslg_scwname ,

     zone_slg.zname AS slg_zname ,
    woreda_slg.woreda_name AS slg_wname ,
    kebele_slg.kname AS slg_kname ,
    city_slg.cname AS slg_cname ,
    subcity_slg.subcity_name AS slg_scname ,
    swcity_slg.sbw_name AS slg_scwname ,
    sgl.maqasgl'); // Alias gslg.operator

    $this->db->where('gslg_id',$gslg_id);
   $this->db->join('sgl', 'sgl.sgl_id = gslg.bslg_id', 'left');
   $this->db->join('woreda AS woreda_gslg', 'woreda_gslg.woreda_id = gslg.woreda_id', 'left');
    $this->db->join('zone AS zone_gslg', 'zone_gslg.zid = gslg.zone_id', 'left');
    $this->db->join('kebele AS kebele_gslg', 'kebele_gslg.kid = gslg.ganda_id', 'left');
     $this->db->join('city AS city_gslg', 'city_gslg.cid = gslg.magala_id', 'left');
    $this->db->join('subcity AS subcity_gslg', 'subcity_gslg.subcity_id = gslg.kmagala_id', 'left');
    $this->db->join('subcity_woreda AS swcity_gslg', 'swcity_gslg.sbw_id = gslg.akmagala_id', 'left');

     $this->db->join('woreda AS woreda_slg', 'woreda_slg.woreda_id = sgl.sworeda_id', 'left');
    $this->db->join('zone AS zone_slg', 'zone_slg.zid = sgl.szone_id', 'left');
    $this->db->join('kebele AS kebele_slg', 'kebele_slg.kid = sgl.sganda_id', 'left');
     $this->db->join('city AS city_slg', 'city_slg.cid = sgl.smagala_id', 'left');
    $this->db->join('subcity AS subcity_slg', 'subcity_slg.subcity_id = sgl.skmagala_id', 'left');
    $this->db->join('subcity_woreda AS swcity_slg', 'swcity_slg.sbw_id = sgl.sakmagala_id', 'left');
...
public function getmbfibb($user){
            $this->db->select('*');
    $this->db->from('mbfibb');
       $this->db->where('operator',$user);
...
public function getistediyemi($user){
            $this->db->select('*');
...
public function getGiddugalaleenjii($user){
            $this->db->select('*');
...
public function getolmaisporti($user){
            $this->db->select('*');
...
public function getHirmaattoota($user){
            $this->db->select('*');
...
//            $woreda = $this->session->userdata('woreda');
      ...
      public function getwaldale($user){
            $this->db->select('*');

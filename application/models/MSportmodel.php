...
class MSportmodel extends CI_Model
{
...
public function getGuddattoota(){
    ...
    $this->db->where('guddattoota.magala_id', $this->session->userdata('city'));
...
public function getgaree(){
            $this->db->select('*');
    $this->db->from('garee');
    $this->db->where('magala_id',$this->session->userdata('magala_id'));
    
    // $this->db->where('garee.magala_id', $this->session->userdata('magala_id'));
...
public function getgslg(){
            $this->db->select('*');
    $this->db->from('gslg');
    $this->db->where('gslg.magala_id', $this->session->userdata('city'));
...
public function getLeenjisummaa(){
            $this->db->select('*');
    $this->db->from('lenji');
    $this->db->where('lenji.magala_id', $this->session->userdata('city'));
...
public function getMurteessummaa(){
            $this->db->select('*');
    $this->db->from('murte');
    $this->db->where('murte.magala_id', $this->session->userdata('city'));
...
public function getsgl(){
            $this->db->select('*');
    $this->db->from('sgl');
    $this->db->where('sgl.smagala_id', $this->session->userdata('city'));
...
public function gettaphata(){
    ...
    $this->db->where('taphata.magala_id', $this->session->userdata('city'));
...
public function getggl(){
    ...
    $this->db->where('gglenji.magala_id', $this->session->userdata('city'));
...
public function getistediyemi(){
    ...
    $this->db->where('istediyemi.magala_id', $this->session->userdata('city'));
...
public function getboimn(){
            $this->db->select('*');
    $this->db->from('boimb');
    $this->db->where('boimb.magala_id', $this->session->userdata('city'));
...
public function getGiddugalaleenjii(){
    ...
    $this->db->where('gidugala.magala_id', $this->session->userdata('city'));
...
public function getolmaisporti(){
    ...
    $this->db->where('olmaisporti.magala_id', $this->session->userdata('city'));
...
public function getHirmaattoota(){
    ...
    $this->db->where('hirmaatota.magala_id', $this->session->userdata('city'));
...
//            $woreda = $this->session->userdata('woreda');
    ...
    $this->db->where('waldale.magala_id', $this->session->userdata('city'));
...
//            $woreda = $this->session->userdata('woreda');
      ...
      public function getclub(){
            ...
            $this->db->select('*');
            $city = $this->session->userdata('city');
            $this->db->where('kilabi.magala_id', $city);
    $this->db->from('kilabi');
   ...
   public function getwirtu(){
            $this->db->select('*');
    $this->db->from('wirtu');
    $this->db->where('wirtu.magala_id', $this->session->userdata('city'));

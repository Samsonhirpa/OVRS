...
public function add_employee() {
       ...
       $data = array(
                'zone' => $this->k->fetch_country(),
                'city' => $this->k->fetch_cityy(),
          );
      ...
      public function checkuser() {
            ...
            if ($ceklogin) {
                  ...
                  $this->session->set_userdata('kebele', $row->kid);

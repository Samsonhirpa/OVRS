...
class ESport extends CI_Controller {
      ...
      public function __construct() {
            ...
            $this->load->model('ESportmodel', 'ek');
 ...
 function fetch_clubtype()
 {
  ...
  {
   echo $this->ek->fetch_clubtype($this->input->post('spt_id'));
  }
 }
 ...
 function fetch_state()
 {
  ...
  {
   echo $this->ek->fetch_state($this->input->post('zid'));
  }
 }
 ...
 function fetch_city()
 {
  ...
  {
   echo $this->ek->fetch_city($this->input->post('woreda_id'));
  }
 }
 ...
 function fetch_subcity()
 {
  ...
  {
   echo $this->ek->fetch_subcity($this->input->post('cid'));
  }
 }
 ...
 function fetch_subcitywd()
 {
  ...
  {
   echo $this->ek->fetch_subcitywd($this->input->post('subcity_id'));
  }
 }
...
public function MadaalliiLenjitootaa() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/madallilist');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_Guddattoota() {
  ...
  $this->session->set_flashdata('msg',"success");
        ...
        redirect('ESport/Guddattoota');
      }

public function Edit_Guddattoota($gu_id) {
            $result = $this->ek->Edit_wirtu($gu_id);
            if ($result) {
...
public function Delete_Guddattoota($gu_id) {
            $result = $this->ek->Delete_Guddattoota($gu_id);
            if ($result) {
...
public function GabasaGGL() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/gabasaggl');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function GabasaSLG() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/gabasaslg');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Gabasakilabi() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/gabasakilabi');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function GabasaTapattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/gabasataphata');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function downloadkarta($ol_id){
        ...
        $fileinfo = $this->ek->downloadkarta($ol_id);
...
public function save_olmaisporti() {
  ...
  $this->session->set_flashdata('msg',"success");
        ...
        redirect('ESport/Oolmaisporti');
      }

// public function save_olmaisporti() {
//             $result = $this->ek->save_olmaisporti();
//             if ($result) {
//                   $this->session->set_flashdata('success_msg', 'Successfully Added');
//             } else {
//                   $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
...
public function Edit_olmaisporti($ol_id) {
            $result = $this->ek->Edit_olmaisporti($ol_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_olmaisporti($ol_id) {
            $result = $this->ek->Delete_olmaisporti($ol_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
{
  if($this->session->userdata('username')){
  $data['murte']=$this->ek->CertificateMurte($mur_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('ESport/murtecertificate',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
{
  if($this->session->userdata('username')){
  $data['lenji']=$this->ek->CertificateLenji($lenji_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('ESport/lenjicertificate',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
public function save_Giddugalaleenjii1() {
            $result = $this->ek->save_Giddugalaleenjii();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Giddugalaleenjii');
      }

public function Edit_Giddugalaleenjii($gl_id) {
            $result = $this->ek->Edit_Giddugalaleenjii($gl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function downloadfile($ins_id){
        $this->load->helper('download');
        $fileinfo = $this->ek->downloadfile($ins_id);
        $file = 'upload/'.$fileinfo['attachment'];
        force_download($file, NULL);
        }
public function save_inisheetivii() {
  ...
  $this->session->set_flashdata('msg',"success");
        ...
        redirect('ESport/inisheetivii');
      }

// public function save_inisheetivii1() {
//             $result = $this->ek->save_inisheetivii();
//             if ($result) {
//                   $this->session->set_flashdata('success_msg', 'Successfully Added');
//             } else {
//                   $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
...
public function Edit_inisheetivii($ins_id) {
            $result = $this->ek->Edit_inisheetivii($ins_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Garee() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/gareeisp');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function addGaree() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/addgaree');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_garee() {
            $result = $this->ek->save_garee();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Garee');
      }

public function Updategaree($gr_id) {
            $result = $this->ek->Updategaree($gr_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_garee($gr_id) {
            $result = $this->ek->Delete_garee($gr_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
{
  if($this->session->userdata('username')){
  $data['gslg']=$this->ek->profileGuddattootaSLG($gslg_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('ESport/profileguddatoota',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
public function GuddattootaSGL() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/guddattootasgl');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_gudslg() {
  $config = array(
        ...
        redirect('ESport/GuddattootaSGL');
      }

      

public function Delete_guddattootasgl($gslg_id) {
            $result = $this->ek->Delete_guddattootasgl($gslg_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Edit_sgl($sgl_id) {
            $result = $this->ek->Edit_sgl($sgl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
{
  if($this->session->userdata('username')){
  $data['taphata']=$this->ek->profiletaphata($tpt_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('EKilaboota/taphataprofile',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
public function Taphattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/taphata');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_taphata11() {
            $result = $this->ek->save_taphata();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Taphattoota');
      }

public function Delete_Taphataa($tpt_id) {
            $result = $this->ek->Delete_Taphataa($tpt_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Waldaalee() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EMaarshal/waldaalee');
            $this->load->view('layout/footer');
      }
      else
      {
   ...
   public function save_Waldaalee11() {
            $result = $this->ek->save_Waldaalee();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Waldaalee');
      }

      public function Edit_Waldaalee($wl_id) {
            $result = $this->ek->Edit_Waldaalee($wl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
      ...
      public function Delete_Waldaalee($wl_id) {
            $result = $this->ek->Delete_Waldaalee($wl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function save_ggl() {
            $result = $this->ek->save_ggl();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/gglenji');
      }

public function Edit_ggl($ggl_id) {
            $result = $this->ek->Edit_ggl($ggl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_ggl($ggl_id) {
            $result = $this->ek->Delete_ggl($ggl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function save_mbfibb() {
            $result = $this->ek->save_mbfibb();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/mbfibb');
      }

public function Edit_mbfibb($mb_id) {
            $result = $this->ek->Edit_mbfibb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_mbfibb($mb_id) {
            $result = $this->ek->Delete_mbfibb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function inisheetivii() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/inisheetivii');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Delete_inisheetivii($ins_id) {
            $result = $this->ek->Delete_inisheetivii($ins_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function istediyemi() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/istediyemi');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_istediyemi() {
            $result = $this->ek->save_istediyemi();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/istediyemi');
      }

public function Edit_istediyemi($std_id) {
            $result = $this->ek->Edit_istediyemi($std_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_istediyemi($std_id) {
            $result = $this->ek->Delete_istediyemi($std_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function boimb() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/boimanabarumsaa');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_boimb() {
            $result = $this->ek->save_boimb();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/boimb');
      }

public function Edit_boimb($mb_id) {
            $result = $this->ek->Edit_boimb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_boimb($mb_id) {
            $result = $this->ek->Delete_boimb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Giddugalaleenjii() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/giddugalaleenjii');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Delete_Giddugalaleenjii($gl_id) {
            $result = $this->ek->Delete_Giddugalaleenjii($gl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Oolmaisporti() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/olmaisporti');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Hirmaattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/hirmaattoota');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_Hirmaattoota() {
            $result = $this->ek->save_Hirmaattoota();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Hirmaattoota');
      }

public function Edit_Hirmaattoota($hir_id) {
            $result = $this->ek->Edit_Hirmaattoota($hir_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_Hirmaattoota($hir_id) {
            $result = $this->ek->Delete_Hirmaattoota($hir_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Guddattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/guddattoota');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Leenjisummaa() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/Leenjisummaa');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Murteessummaa() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ESport/murteessummaa');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_murteessummaa() {
            $result = $this->ek->save_murteessummaa();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Murteessummaa');
      }

public function Delete_lenjim($mur_id) {
            $result = $this->ek->Delete_lenjim($mur_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function save_Leenjisummaa() {
            $result = $this->ek->save_Leenjisummaa();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Leenjisummaa');
      }

public function Delete_lenji($lenji_id) {
            $result = $this->ek->Delete_lenji($lenji_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Delete_mmi($mmi_id) {
            $result = $this->ek->Delete_mmi($mmi_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Marshal_arti() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EMaarshal/wirtu');
            $this->load->view('layout/footer');
      }
      else
      {
   ...
   public function save_wirtu() {
            $result = $this->ek->save_wirtu();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ESport/Marshal_arti');
      }

      public function Edit_wirtu($w_id) {
            $result = $this->ek->Edit_wirtu($w_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
      ...
      public function Delete_wirtu($w_id) {
            $result = $this->ek->Delete_wirtu($w_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function addclub(){
      if ($this->session->userdata('username')) {
           $data['sporttype'] = $this->ek->fetch_sporttype();
       $this->load->view('layout/header');
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/create' ,$data);
...
public function editclub($k_id){
      if ($this->session->userdata('username')) {
        $data['kilabi']=$this->ek->editclub($k_id);
       $this->load->view('layout/header');
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/edit' ,$data);
            $this->load->view('layout/footer.php');
...
public function manageclub(){
      if ($this->session->userdata('username')) {
       $this->load->view('layout/header');
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('EKilaboota/manage');
            $this->load->view('layout/footer.php');
...
public function saveclub() {
            ...
            redirect('ESport/manageclub');
      }
 public function Updateclub($k_id) {
            $result = $this->ek->Updateclub($k_id);
            if ($result) {
...
public function deleteclub($k_id) {
            $result = $this->ek->deleteclub($k_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');

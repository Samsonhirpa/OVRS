...
class ZoneSport extends CI_Controller {
...
public function MadaalliiLenjitootaa() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/madallilist');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_Guddattoota() {
  ...
  $this->session->set_flashdata('msg',"success");
        ...
        redirect('ZoneSport/Guddattoota');
      }
...
public function Delete_Guddattoota($gu_id) {
            $result = $this->zk->Delete_Guddattoota($gu_id);
            if ($result) {
...
public function GabasaGGL() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/gabasaggl');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function GabasaSLG() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/gabasaslg');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Gabasakilabi() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/gabasakilabi');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function GabasaTapattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/gabasataphata');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_olmaisporti() {
  ...
  $this->session->set_flashdata('msg',"success");
        ...
        redirect('ZoneSport/Oolmaisporti');
      }
...
public function Edit_olmaisporti($ol_id) {
            $result = $this->zk->Edit_olmaisporti($ol_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_olmaisporti($ol_id) {
            $result = $this->zk->Delete_olmaisporti($ol_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
{
  if($this->session->userdata('username')){
  $data['murte']=$this->zk->CertificateMurte($mur_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('Zsport/murtecertificate',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
{
  if($this->session->userdata('username')){
  $data['lenji']=$this->zk->CertificateLenji($lenji_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('Zsport/lenjicertificate',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
public function save_Giddugalaleenjii1() {
            ...
            redirect('ZoneSport/Giddugalaleenjii');
      }
...
public function Garee() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/gareeisp');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function addGaree() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/addgaree');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_garee() {
            $result = $this->zk->save_garee();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/Garee');
      }

public function Updategaree($gr_id) {
            $result = $this->zk->Updategaree($gr_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_garee($gr_id) {
            $result = $this->zk->Delete_garee($gr_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
{
  if($this->session->userdata('username')){
  $data['gslg']=$this->zk->profileGuddattootaSLG($gslg_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
  $this->load->view('Zsport/profileguddatoota',$data);
  $this->load->view('layout/footer');
}
  else
  {
...
public function GuddattootaSGL() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/guddattootasgl');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_gudslg() {
  $config = array(
        ...
        redirect('ZoneSport/GuddattootaSGL');
      }
...
public function save_sgl() {
            $result = $this->zk->save_sgl();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/SGL');
      }

public function Edit_sgl($sgl_id) {
            $result = $this->zk->Edit_sgl($sgl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
{
  if($this->session->userdata('username')){
  $data['taphata']=$this->zk->profiletaphata($tpt_id);
  $this->load->view('layout/header');
  $this->load->view('layout/topmenu');
  $this->load->view('layout/sidemenu');
...
public function Taphattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/taphata');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_taphata11() {
            ...
            redirect('ZoneSport/Taphattoota');
      }

public function Delete_Taphataa($tpt_id) {
            $result = $this->zk->Delete_Taphataa($tpt_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Waldaalee() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZMaarshal/waldaalee');
            $this->load->view('layout/footer');
      }
      else
      {
   ...
   public function save_Waldaalee11() {
            $result = $this->zk->save_Waldaalee();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/Waldaalee');
      }

      public function Edit_Waldaalee($wl_id) {
            $result = $this->zk->Edit_Waldaalee($wl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
      ...
      public function Delete_Waldaalee($wl_id) {
            $result = $this->zk->Delete_Waldaalee($wl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function save_ggl() {
            $result = $this->zk->save_ggl();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/gglenji');
      }

public function Edit_ggl($ggl_id) {
            $result = $this->zk->Edit_ggl($ggl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_ggl($ggl_id) {
            $result = $this->zk->Delete_ggl($ggl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function save_mbfibb() {
            $result = $this->zk->save_mbfibb();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/mbfibb');
      }

public function Edit_mbfibb($mb_id) {
            $result = $this->zk->Edit_mbfibb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_mbfibb($mb_id) {
            $result = $this->zk->Delete_mbfibb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function istediyemi() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/istediyemi');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_istediyemi() {
            ...
            redirect('ZoneSport/istediyemi');
      }

public function Edit_istediyemi($std_id) {
            $result = $this->zk->Edit_istediyemi($std_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_istediyemi($std_id) {
            $result = $this->zk->Delete_istediyemi($std_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function boimb() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/boimanabarumsaa');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_boimb() {
            $result = $this->zk->save_boimb();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/boimb');
      }

public function Edit_boimb($mb_id) {
            $result = $this->zk->Edit_boimb($mb_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Giddugalaleenjii() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/giddugalaleenjii');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Delete_Giddugalaleenjii($gl_id) {
            $result = $this->zk->Delete_Giddugalaleenjii($gl_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Oolmaisporti() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/olmaisporti');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Hirmaattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/hirmaattoota');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_Hirmaattoota() {
            $result = $this->zk->save_Hirmaattoota();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/Hirmaattoota');
      }

public function Edit_Hirmaattoota($hir_id) {
            $result = $this->zk->Edit_Hirmaattoota($hir_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
...
public function Delete_Hirmaattoota($hir_id) {
            $result = $this->zk->Delete_Hirmaattoota($hir_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Guddattoota() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/guddattoota');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Leenjisummaa() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/Leenjisummaa');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function Murteessummaa() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('Zsport/murteessummaa');
            $this->load->view('layout/footer');
      }
      else
      {
...
public function save_murteessummaa() {
            $result = $this->zk->save_murteessummaa();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/Murteessummaa');
      }
...
public function save_Leenjisummaa() {
            $result = $this->zk->save_Leenjisummaa();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/Leenjisummaa');
      }

public function Delete_lenji($lenji_id) {
            $result = $this->zk->Delete_lenji($lenji_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function Marshal_arti() {
           ...
           if($this->session->userdata('username')){
            ...
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZMaarshal/wirtu');
            $this->load->view('layout/footer');
      }
      else
      {
   ...
   public function save_wirtu() {
            $result = $this->zk->save_wirtu();
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Added');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Add Please Try Again');
            }
            redirect('ZoneSport/Marshal_arti');
      }

      public function Edit_wirtu($w_id) {
            $result = $this->zk->Edit_wirtu($w_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Updated');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Update Please Try Again');
      ...
      public function Delete_wirtu($w_id) {
            $result = $this->zk->Delete_wirtu($w_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
...
public function addclub(){
      if ($this->session->userdata('username')) {
       ...
       $this->load->view('layout/header');
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/create' ,$data);
...
public function editclub($k_id){
      if ($this->session->userdata('username')) {
       ...
       $this->load->view('layout/header');
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/edit' ,$data);
            $this->load->view('layout/footer.php');
...
public function manageclub(){
      if ($this->session->userdata('username')) {
       $this->load->view('layout/header');
            $this->load->view('layout/topmenu');
            $this->load->view('layout/sidemenu');
            $this->load->view('ZKilaboota/manage');
            $this->load->view('layout/footer.php');
...
public function saveclub() {
            ...
            redirect('ZoneSport/manageclub');
      }
 public function Updateclub($k_id) {
            $result = $this->zk->Updateclub($k_id);
            if ($result) {
...
public function deleteclub($k_id) {
            $result = $this->zk->deleteclub($k_id);
            if ($result) {
                  $this->session->set_flashdata('success_msg', 'Successfully Deleted');
            } else {
                  $this->session->set_flashdata('error_msg', 'Failed To Deleted Please Try Again');
